...
public class UnbilledRep2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unbilled_rep2);
    ...
    public void startLoadData() {
        ...
        mProgressBar.setMessage("Fetching Consumers..");
    ...
    public void loadData() {
        ...
        InvoiceData[] data = invoices.getInvoices(records);

        SimpleDateFormat dateFormat = new SimpleDateFormat("dd MMM, yyyy");
        DecimalFormat decimalFormat = new DecimalFormat("0.00");

        int rows = data.length;
        getSupportActionBar().setTitle("Consumers (" + String.valueOf(rows) + ")");
        ...
        for(int i = -1; i < rows; i ++) {
            ...
            if (i == -1) {
                ...
                tv.setText(String.valueOf(row.BPNO));
                tv.setTextSize(TypedValue.COMPLEX_UNIT_PX, smallTextSize);
            }
...
//                tv2.setText(dateFormat.format(row.customerName));
            }
*/
            ...
            if (i > -1) {
                ...
                tv3b.setTextColor(Color.parseColor("#6FA8DC"));
                tv3b.setBackgroundColor(Color.parseColor("#f8f8f8"));
                tv3b.setText(row.Mobno);
